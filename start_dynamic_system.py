        ...
        for line in iter(process.stdout.readline, ''):
            if line.strip():
                try:
                    ...
                    print(f"[{name}] <output with encoding issues>")
...
def install_frontend_dependencies():
    ...
    frontend_dir = Path(r"C:\Users\nisar\Downloads\vaani-sentinel-x-3ef299a9a0e53c7c877ad646167c909855be86e7 (2)\vaani-sentinel-x-3ef299a9a0e53c7c877ad646167c909855be86e7\web-ui\nextjs-voice-panel")
...
def start_frontend():
    ...
    run_command(frontend_command, cwd=frontend_dir, name="React Frontend")
